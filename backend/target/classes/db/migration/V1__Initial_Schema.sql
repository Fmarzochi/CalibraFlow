...
CREATE INDEX idx_periodicities_tenant ON periodicities(tenant_id);
CREATE INDEX idx_periodicities_category ON periodicities(category_id);
...
CREATE INDEX idx_instruments_location ON instruments(location_id);
...
CREATE INDEX idx_calibrations_tenant ON calibrations(tenant_id);
...
CREATE INDEX idx_certificates_calibration ON certificates(calibration_id);
...
CREATE INDEX idx_history_instrument ON instrument_status_history(instrument_id);
CREATE INDEX idx_history_tenant ON instrument_status_history(tenant_id);
...
CREATE INDEX idx_movements_instrument ON movements(instrument_id);
